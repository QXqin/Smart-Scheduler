...
import com.smartscheduler.app.ui.todo.TodoViewModel_HiltModules_KeyModule_Provide_LazyMapKey;
...
public final class DaggerSmartSchedulerApp_HiltComponents_SingletonC {
  private DaggerSmartSchedulerApp_HiltComponents_SingletonC() {
  }
  ...
  public static final class Builder {
    ...
    public SmartSchedulerApp_HiltComponents.SingletonC build() {
      Preconditions.checkBuilderRequirement(applicationContextModule, ApplicationContextModule.class);
      return new SingletonCImpl(applicationContextModule);
    }
  }

  private static final class ActivityRetainedCBuilder implements SmartSchedulerApp_HiltComponents.ActivityRetainedC.Builder {
    ...
    @Override
    public SmartSchedulerApp_HiltComponents.ActivityRetainedC build() {
      Preconditions.checkBuilderRequirement(savedStateHandleHolder, SavedStateHandleHolder.class);
      return new ActivityRetainedCImpl(singletonCImpl, savedStateHandleHolder);
    }
  }

  private static final class ActivityCBuilder implements SmartSchedulerApp_HiltComponents.ActivityC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public SmartSchedulerApp_HiltComponents.ActivityC build() {
      Preconditions.checkBuilderRequirement(activity, Activity.class);
      return new ActivityCImpl(singletonCImpl, activityRetainedCImpl, activity);
    }
  }

  private static final class FragmentCBuilder implements SmartSchedulerApp_HiltComponents.FragmentC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public SmartSchedulerApp_HiltComponents.FragmentC build() {
      Preconditions.checkBuilderRequirement(fragment, Fragment.class);
      return new FragmentCImpl(singletonCImpl, activityRetainedCImpl, activityCImpl, fragment);
    }
  }

  private static final class ViewWithFragmentCBuilder implements SmartSchedulerApp_HiltComponents.ViewWithFragmentC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public SmartSchedulerApp_HiltComponents.ViewWithFragmentC build() {
      Preconditions.checkBuilderRequirement(view, View.class);
      return new ViewWithFragmentCImpl(singletonCImpl, activityRetainedCImpl, activityCImpl, fragmentCImpl, view);
    }
  }

  private static final class ViewCBuilder implements SmartSchedulerApp_HiltComponents.ViewC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public SmartSchedulerApp_HiltComponents.ViewC build() {
      Preconditions.checkBuilderRequirement(view, View.class);
      return new ViewCImpl(singletonCImpl, activityRetainedCImpl, activityCImpl, view);
    }
  }

  private static final class ViewModelCBuilder implements SmartSchedulerApp_HiltComponents.ViewModelC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public SmartSchedulerApp_HiltComponents.ViewModelC build() {
  ...
  private static final class ServiceCBuilder implements SmartSchedulerApp_HiltComponents.ServiceC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public SmartSchedulerApp_HiltComponents.ServiceC build() {
      Preconditions.checkBuilderRequirement(service, Service.class);
      return new ServiceCImpl(singletonCImpl, service);
    }
  }

  private static final class ViewWithFragmentCImpl extends SmartSchedulerApp_HiltComponents.ViewWithFragmentC {
    private final SingletonCImpl singletonCImpl;
  ...
  private static final class FragmentCImpl extends SmartSchedulerApp_HiltComponents.FragmentC {
    private final SingletonCImpl singletonCImpl;
  ...
  private static final class ViewCImpl extends SmartSchedulerApp_HiltComponents.ViewC {
    private final SingletonCImpl singletonCImpl;
  ...
  private static final class ActivityCImpl extends SmartSchedulerApp_HiltComponents.ActivityC {
    private final SingletonCImpl singletonCImpl;
  ...
  private static final class ViewModelCImpl extends SmartSchedulerApp_HiltComponents.ViewModelC {
    private final SingletonCImpl singletonCImpl;
    ...
    private GenerateScheduleUseCase generateScheduleUseCase() {
      return new GenerateScheduleUseCase(singletonCImpl.eventRepositoryProvider.get(), singletonCImpl.todoRepositoryProvider.get(), singletonCImpl.llmRepositoryProvider.get(), singletonCImpl.settingsRepositoryProvider.get());
    }
  ...
  private static final class ActivityRetainedCImpl extends SmartSchedulerApp_HiltComponents.ActivityRetainedC {
    private final SingletonCImpl singletonCImpl;
  ...
  private static final class ServiceCImpl extends SmartSchedulerApp_HiltComponents.ServiceC {
    private final SingletonCImpl singletonCImpl;
  ...
  private static final class SingletonCImpl extends SmartSchedulerApp_HiltComponents.SingletonC {
    ...
    private Provider<IcsParser> icsParserProvider;

    private Provider<TodoRepository> todoRepositoryProvider;

    private Provider<Moshi> provideMoshiProvider;

    private Provider<LlmRepository> llmRepositoryProvider;
    ...
    private FixedEventDao fixedEventDao() {
      return AppModule_ProvideFixedEventDaoFactory.provideFixedEventDao(provideDatabaseProvider.get());
    }

    private ScheduledBlockDao scheduledBlockDao() {
      return AppModule_ProvideScheduledBlockDaoFactory.provideScheduledBlockDao(provideDatabaseProvider.get());
    }
    ...
    private void initialize(final ApplicationContextModule applicationContextModuleParam) {
      ...
      this.icsParserProvider = DoubleCheck.provider(new SwitchingProvider<IcsParser>(singletonCImpl, 2));
      this.todoRepositoryProvider = DoubleCheck.provider(new SwitchingProvider<TodoRepository>(singletonCImpl, 3));
    ...
    @Override
    public void injectSmartSchedulerApp(SmartSchedulerApp smartSchedulerApp) {
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.smartscheduler.app.data.repository.EventRepository 
          return (T) new EventRepository(singletonCImpl.fixedEventDao(), singletonCImpl.scheduledBlockDao());

          case 1: // com.smartscheduler.app.data.local.AppDatabase 
          return (T) AppModule_ProvideDatabaseFactory.provideDatabase(ApplicationContextModule_ProvideContextFactory.provideContext(singletonCImpl.applicationContextModule));

          case 2: // com.smartscheduler.app.util.IcsParser 
          return (T) new IcsParser();

          case 3: // com.smartscheduler.app.data.repository.TodoRepository 
          return (T) new TodoRepository(singletonCImpl.todoDao());

          case 4: // com.smartscheduler.app.data.repository.LlmRepository 
          return (T) new LlmRepository(singletonCImpl.provideMoshiProvider.get());
